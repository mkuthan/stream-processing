...
trait VehicleRegistrationFixture {
  ...
  final val anyVehicleRegistrationPayload: VehicleRegistration.Payload = VehicleRegistration.Payload(
    id = "1",
  ...
  final val vehicleRegistrationPayloadInvalid: VehicleRegistration.Payload =
